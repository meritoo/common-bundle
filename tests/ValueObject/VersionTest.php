...
class VersionTest extends TestCase
{
     ...
     */
    public function testToString(Version $version, string $expected): void
    {
     ...
     * @param Version $expected Expected version
     *
     * @dataProvider provideAsString
     */
    public function testFromString(string $version, ?Version $expected): void
    {
     ...
     */
    public function testFromArray(array $version, ?Version $expected): void
    {
     ...
     * @return Generator
     */
    public function provideConvertedToString(): Generator
    {
        yield[
            new Version(0, 0, 0),
            '0.0.0',
     ...
     * @return Generator
     */
    public function provideAsArray(): Generator
    {
        yield[
            [],
            null,
